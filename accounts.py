...
'''
print ("x" * (len(answer) - 4) + answer[-4:]) # used len and -4 to replace all of the numbers with x's other than last 4 digits, Used answer[-4:] to show only the last 4 digits.